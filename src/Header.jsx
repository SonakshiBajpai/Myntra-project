...
const Header = () => {
  ...
  const dropdownContent = {
    ...
    "Ethnic-and-Eco": [
      { name: "Indian Handloom", link: "/IndianHandloom" },
      { name: "Animal Welfare", link: "/AnimalWellfare" },
    ],
  };
  ...
  return (
    <header className="header">
      <Link to="/">
        <div className="logo">
          <img
            src="https://img.etimg.com/thumb/msid-80732141,width-480,height-360,imgsize-57026,resizemode-75/signs-of-trouble.jpg"
            alt="Logo"
          />
        </div>
      </Link>
            ...
            {activeSection === section && isDropdownVisible && (
              <ul className="dropdown">
                {dropdownContent[section] &&
                  dropdownContent[section].map((item, index) => (
